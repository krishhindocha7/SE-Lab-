...
void merge_sort(double *array, double *tmp, double size);
void merge_r(double *src, double *tmp, double start, double mid, double end);
...
double numTh[9]={1,2,4,6,8,10,12,14,16};
  srand(time(NULL));
  
  // generate random numbers for double type array
...
void merge_sort(double *src, double *tmp, double size) {
  double i, stride=100;
